...
const hireStep = [
  ...
  "Receba várias propostas e contrate com total segurança.",
  "Agenda a data, hora e local que deseja ter o serviço executado.",
  "Viva livre de estresse e deixe-nos cuidar dos seus problemas.",
];

const providerSteps = [
  "Acesso direito a milhares de clientes com necessidades.",
  "Faça dinheiro com as suas habilidades.",
  "Nunca perca uma oportunidade. Receba todas notificações de solicitações de serviço em seu telemóvel.",
  "Garantia de pagamento – Não corra riscos! Conclua o seu trabalho e receba o pagamento no App.",
];
            ...
            <header>
              ...
              <div className="mt-10 z-20 relative max-w-lg">
                ...
                <p className="mt-5 text-gray-700 text-lg">
                  Tornamos o processo o contratação 10x mais rápido.
          ...
          <div className="grid grid-cols-1 pot:grid-cols-2 pot:px-0 px-2 gap-2">
              ...
              <div className="w-full h-full flex flex-col justify-end bg-linear-to-b from-transparent p-5 pot:p-8 to-85% to-black">
                <div className="max-w-md">
                  ...
                  <p className="text-white/80 pt-1 font-normal text-md">
                    Mais opções, menos estresse. Solicite e contrate o
                    profissional que você precisa em segundos.
                  </p>

                  <div className="flex flex-col mt-5 gap-3">
                    {hireStep.map((step, index) => (
                      <div
                        key={index}
                        className="text-white  flex  items-start gap-3"
                      >
                        <div>
                          <div className="size-2 mt-2 bg-contrast" />
                        </div>
                        {step}
                      </div>
                    ))}
            ...
            >
              <div className="w-full h-full flex flex-col justify-end bg-linear-to-b from-transparent p-8 to-85% to-black">
                <div className="max-w-md">
                  <h2 className="text-white text-3xl">É fácil trabalhar!</h2>
                  <p className="text-white/80 pt-1 font-normal text-md">
                    Chega de perder oportunidade com aquilo que sabes fazer de
                    melhor.
                  </p>
