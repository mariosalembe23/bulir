          ...
          <>
            <AlertDialogHeader>
              <AlertDialogTitle className="flex items-center gap-3">
                ...
                {user?.name || "Perfil de Usuário"}
              </AlertDialogTitle>
              <AlertDialogDescription>
                {user?.role === "PROVIDER"
                  ? "Este é um perfil de um prestador de serviços. Você pode visualizar como os clientes verão seu perfil."
                  : "Este é um perfil de um cliente. Você pode visualizar como os prestadores de serviços verão seu perfil."}
              </AlertDialogDescription>
            </AlertDialogHeader>
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                <p className="text-zinc-600">NIF</p>
                <p className="font-mono">{user?.nif || "NIF não disponível"}</p>
              </div>
              <div className="flex flex-col gap-1">
                <p className="text-zinc-600">E-mail</p>
                <p className="font-mono">
                  {user?.email || "NIF não disponível"}
                </p>
              </div>
              <div className="flex flex-col gap-1">
                <p className="text-zinc-600">Registrado há</p>
                <p className="font-mono">
